        ...
        <form onSubmit={handleSubmit} className="p-4">
          <div className="row">
            ...
            <div className="col-md-6">
              <label htmlFor="expenseType" className="form-label">Tipo de Gasto:</label>
              <input 
                type="text" 
                name="expenseType" 
                id="expenseType" 
              ...
              <label htmlFor="amount" className="form-label mt-3">Monto:</label>
              <input 
                type="number" 
                name="amount" 
                id="amount" 
          ...
          <div className="text-center mt-4 pt-3">
            <button type="submit" className="btn btn-confirm">Registrar Gasto</button>
          </div>
        </form>

        {error && (
          <div className="alert alert-danger mt-1 text-center mx-2" role="alert">
            <AlertTriangle />
